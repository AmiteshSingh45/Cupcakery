  ...
  <section className="py-16 px-6 text-center bg-gradient-to-b from-gray-50 to-gray-100">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mt-10">
      {[
        ...
        { name: "Brownies", img: "/hpbrowniesproduct.jpg", link: "/category/brownies" },
        { name: "Cookies", img: "/hpcookiesproduct1.jpg", link: "/category/cookies" },
        { name: "Truffle", img: "/hptruffleproduct.jpg", link: "/category/truffle" },
      ].map((item, index) => (
