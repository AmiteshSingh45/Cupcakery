...
// ── Canonical order statuses — MUST match Backend/Models/paymentModel.js ORDER_STATUSES ──
...
// ── Full stage pipeline for the visual order tracker ──────────────────────
export const ORDER_STAGES = [
  {
    key: "Pending Approval",
    label: "Order Placed",
    icon: "🛍️",
    description: "Your order has been placed and is awaiting admin review.",
    color: "#D4A853",
  },
  {
    key: "Approved",
    ...
    icon: "✅",
    description: "Great news! Your order has been approved by our team.",
    color: "#22c55e",
  },
  {
    key: "Preparing",
  ...
  },
  {
    ...
    icon: "🔥",
    description: "Your delicious treats are in the oven!",
    color: "#ef4444",
  },
  {
    key: "Packed",
    label: "Order Packed",
    icon: "📦",
    description: "Your order has been beautifully packed and is ready for pickup.",
    color: "#8b5cf6",
  },
  {
  ...
  },
  {
    ...
    label: "Delivered!",
    icon: "🎉",
    description: "Your order has been delivered. Enjoy your treats!",
    color: "#22c55e",
  },
];

// Terminal statuses (not shown in tracker pipeline)
export const TERMINAL_STATUSES = ["Cancelled", "Rejected", "Refunded"];
